...
def load_a(path):
    ...
    with open(path, newline='') as f:
        rd = csv.DictReader(f)
        for r in rd:
            Tk = int(r['Tk']); row = int(r['r']); k = int(r['k']); val = int(r['val'])
            A[Tk][row][k] = val
    return A
...
def load_b(path):
    ...
    with open(path, newline='') as f:
        rd = csv.DictReader(f)
        for r in rd:
            Tk = int(r['Tk']); k = int(r['k']); col = int(r['c']); val = int(r['val'])
            B[Tk][k][col] = val
    return B
...
def load_c(path):
    ...
    with open(path, newline='') as f:
        rd = csv.DictReader(f)
        for r in rd:
            Tk = int(r['Tk']); row = int(r['r']); col = int(r['c']); val = int(r['val'])
            C[Tk][row][col] = val
    return C
